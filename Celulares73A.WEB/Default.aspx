    ...
    <table style="width: 91%; height: 156px;">
            ...
            <tr>
                ...
                <td align="left" style="width: 644px; height: 125px;">
                    <b style="font-size:20px"><%=a.Fabricante.Nome + " " + a.Modelo %></b><br />
                    <b style="font-size:24px">R$: <%=a.Preco.ToString("C") %></b><br />
                    <i style="font-size:20px"><%=a.Quantidade %> em estoque</i><br />
                    <b style="font-size:20px"><a href="Detalhes.aspx?aparelho=<%=a.Id_Aparelho %>">Mais detalhes</a></b>
                </td>
            </tr>
            <% } %>
        </table>
